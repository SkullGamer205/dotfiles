...
local WIDGET_DIR = HOME .. '/.config/awesome/ui/wibar/module/'
...
local function worker(user_args)
    ...
    function(widget, stdout)
        ...
        if (charge >= 1 and charge < 15) then
            batteryType = "battery-10%s-symbolic"
        ...
        elseif (charge >= 15 and charge < 40) then batteryType = "battery-30%s-symbolic"
        elseif (charge >= 40 and charge < 60) then batteryType = "battery-50%s-symbolic"
        elseif (charge >= 60 and charge < 80) then batteryType = "battery-70%s-symbolic"
        elseif (charge >= 80 and charge <= 100) then batteryType = "battery-100%s-symbolic"
        end
