...
local utils = require("ui.wibar.module.aww.volume-widget.utils")

local LIST_DEVICES_CMD = [[sh -c "pacmd list-sinks"]]
...
local widget_types = {
	icon_and_text = require("ui.wibar.module.aww.volume-widget.widgets.icon-and-text-widget"),
	icon = require("ui.wibar.module.aww.volume-widget.widgets.icon-widget"),
	arc = require("ui.wibar.module.aww.volume-widget.widgets.arc-widget"),
	horizontal_bar = require("ui.wibar.module.aww.volume-widget.widgets.horizontal-bar-widget"),
	vertical_bar = require("ui.wibar.module.aww.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
...
local function rebuild_popup()
	spawn.easy_async(LIST_DEVICES_CMD, function(stdout)
		local sinks = utils.extract_sinks_and_sources(stdout)
