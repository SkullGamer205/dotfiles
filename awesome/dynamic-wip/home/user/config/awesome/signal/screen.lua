...
screen.connect_signal('request::desktop_decoration', function(s)
   ...
   awful.tag(require('config.user').tags, s, awful.layout.layouts[4])
   l = awful.layout.layouts
   retain.tags.defaults.names = {"A", "B", "C"}
   retain.tags.defaults.layouts = {l[4]}
   retain.tags.savefile = gears.filesystem.get_configuration_dir() .. "module/awesome-retain/.cache"
   retain.tags.load()
