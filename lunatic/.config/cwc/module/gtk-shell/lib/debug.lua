-- Source: https://github.com/linuxmobile/astal-bar/blob/main/lua/lib/debug.lua
--
...
local LOG_DIR = GLib.get_user_data_dir() .. "/lunatic-shell"
local LOG_FILE = LOG_DIR .. '/lunatic_shell_log_' .. os.date('%Y_%m_%d_%H_%M_%S') .. '.log'
